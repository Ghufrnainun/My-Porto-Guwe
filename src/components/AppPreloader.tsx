            ...
            >
              <div className="rounded-[calc(2rem-0.5rem)] bg-foreground/[0.03] px-6 py-7 shadow-[inset_0_1px_1px_hsl(var(--foreground)/0.1)]">
                ...
                <div className="mt-8 space-y-3">
                  <p className="font-serif text-[clamp(2rem,8vw,4.4rem)] italic leading-[0.9] tracking-[-0.06em] text-foreground">
                    warming up
                  </p>
                ...
                <div className="mt-8 h-px overflow-hidden rounded-full bg-foreground/10">
                  <motion.div
                    className="h-full origin-left bg-foreground"
                    initial={{ scaleX: 0 }}
                    animate={{ scaleX: 1 }}
                    transition={{ duration: shouldReduceMotion ? 0.15 : 1.15, ease: easeOutQuint }}
                  />
                </div>
              </div>
            </motion.div>
